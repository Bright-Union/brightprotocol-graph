...
export class Distributor__claimTokensResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
...
export class Distributor__getCoverResult {
  value0: i32;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class Distributor__getPayoutOutcomeResult {
  value0: i32;
  value1: BigInt;
  value2: Address;
...
export class Distributor extends ethereum.SmartContract {
  ...
  claimTokens(
    ...
    coverAsset: Address
  ): Distributor__claimTokensResult {
    let result = super.call(
      "claimTokens",
    ...
    return new Distributor__claimTokensResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress()
    );
  ...
  try_claimTokens(
    ...
    coveredTokenAmount: BigInt,
    coverAsset: Address
  ): ethereum.CallResult<Distributor__claimTokensResult> {
    let result = super.tryCall(
      "claimTokens",
      "claimTokens(uint256,uint256,uint256,address):(uint256,uint256,address)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Distributor__claimTokensResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toAddress()
      )
  ...
  getCover(tokenId: BigInt): Distributor__getCoverResult {
    let result = super.call(
      "getCover",
    ...
    return new Distributor__getCoverResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_getCover(
    tokenId: BigInt
  ): ethereum.CallResult<Distributor__getCoverResult> {
    let result = super.tryCall(
      "getCover",
      "getCover(uint256):(uint8,uint256,uint16,uint256,address,address,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Distributor__getCoverResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  getPayoutOutcome(claimId: BigInt): Distributor__getPayoutOutcomeResult {
    let result = super.call(
      "getPayoutOutcome",
    ...
    return new Distributor__getPayoutOutcomeResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toAddress()
    );
  ...
  try_getPayoutOutcome(
    claimId: BigInt
  ): ethereum.CallResult<Distributor__getPayoutOutcomeResult> {
    let result = super.tryCall(
      "getPayoutOutcome",
      "getPayoutOutcome(uint256):(uint8,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(claimId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Distributor__getPayoutOutcomeResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toAddress()
      )
